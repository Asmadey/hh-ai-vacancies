...
```
Agent(
  prompt="Read /Users/asmadey/AntiGravity/DEMO/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/templates/VALIDATION.md`
