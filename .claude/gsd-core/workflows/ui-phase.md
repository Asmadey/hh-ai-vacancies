...
```markdown
Read /Users/asmadey/AntiGravity/DEMO/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/asmadey/AntiGravity/DEMO/.claude/agents/gsd-ui-checker.md for instructions.
...
@/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/asmadey/AntiGravity/DEMO/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/asmadey/AntiGravity/DEMO/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
