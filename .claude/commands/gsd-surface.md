...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/asmadey/AntiGravity/DEMO/.claude/.gsd-surface.json`
(sibling to `/Users/asmadey/AntiGravity/DEMO/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/asmadey/AntiGravity/DEMO/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/asmadey/AntiGravity/DEMO/.claude/skills`).
...
`/Users/asmadey/AntiGravity/DEMO/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/asmadey/AntiGravity/DEMO/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/asmadey/AntiGravity/DEMO/.claude/.gsd-surface.json`
Install profile marker: `/Users/asmadey/AntiGravity/DEMO/.claude/.gsd-profile`
Skill dirs: `/Users/asmadey/AntiGravity/DEMO/.claude/skills/gsd-*/`
Engine module: `/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
