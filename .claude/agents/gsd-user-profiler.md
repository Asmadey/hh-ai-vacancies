...
<reference>
@/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/asmadey/AntiGravity/DEMO/.claude/gsd-core/references/user-profiling.md` to load:
